  ...
  <section class="section" style="background:var(--bg-primary)">
    <div class="container">
      ...
      <div class="video-grid">
        <div v-for="(v, i) in videoCards" :key="i" class="video-card" @click="$emit('openVideo', `${baseUrl}VIDEO/${i + 4}.mp4`)">
          <div class="video-card-thumb">
            <img :src="`${baseUrl}VIDEO/thumbs/${i + 4}.jpg`" :alt="v.title" loading="lazy" />
          </div>
...
const videoCards = useTm('home.videoCards')
const videoMore = useTm('home.videoMore')
